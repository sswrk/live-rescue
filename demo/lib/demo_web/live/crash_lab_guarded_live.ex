defmodule DemoWeb.CrashLabGuardedLive do
  @moduledoc """
  LiveRescue protected crash lab.
  LiveRescue catches errors in handle_event, handle_info, and handle_params callbacks.
  """
  use DemoWeb, :live_view
  use LiveRescue

  alias DemoWeb.CrashLab.Guarded.{
  ...
  def handle_event("crash_here", _params, _socket) do
    raise "Simulated crash in CrashLabGuardedLive.handle_event"
  end
